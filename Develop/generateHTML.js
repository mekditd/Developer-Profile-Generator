  ...
  <html lang="en">
    ...
    <div class="wrapper">
        ...
        <div class="photo-header">
          <img class="photo-header align: center" src="${userData.proPic}" alt="profile-img">
        ...
        <div class="links-nav">
          <span class="nav-link"><a href="https://www.google.com/maps/place/${userData.location}">Location-${userData.location}</a></span>
